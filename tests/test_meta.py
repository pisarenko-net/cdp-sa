...
class MusicbrainzTestCase(unittest.TestCase):
    ...
    def test_cd_01(self):
        ...
        with patch('musicbrainzngs.get_releases_by_discid', return_value=response) as mock_method:
            ...
            self.assertEqual(disc_meta['artist'], 'David Bowie')
    ...
    def test_cd_02(self):
        ...
        with patch('musicbrainzngs.get_releases_by_discid', return_value=response) as mock_method:
            ...
            self.assertEqual(disc_meta['artist'], 'ZZ Top')
    ...
    def test_cd_03(self):
        ...
        with patch('musicbrainzngs.get_releases_by_discid', return_value=response) as mock_method:
            ...
            self.assertEqual(disc_meta['cd'], 1)
            self.assertEqual(disc_meta['total_cds'], 1)
            self.assertEqual(disc_meta['artist'], 'Queen')
    ...
    def test_cd_04(self):
        ...
        with patch('musicbrainzngs.get_releases_by_discid', return_value=response) as mock_method:
            ...
            self.assertEqual(disc_meta['artist'], 'Eagles')
    ...
    def test_cd_06(self):
        ...
        with patch('musicbrainzngs.get_releases_by_discid', return_value=response) as mock_method:
            ...
            self.assertNotIn('artist', disc_meta)
